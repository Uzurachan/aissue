...
def main():
    ...
    table = build_table(issues) if issues else "<p>Issueが見つかりません。</p>"

    page = PAGE_TEMPLATE.format(
        style=STYLE, generated_at=html.escape(generated_at), table=table
    )
